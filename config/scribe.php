...
return [
    ...
    'routes' => [
        [
            'match' => [
                // تغيير النجمة هنا يجعلها تبحث في أي مسار يبدأ بـ api/
                'prefixes' => ['api/*'],
                
                // التأكد من أن النطاق يشمل الكل
                'domains' => ['*'],
            ],
            
            // إضافة مهمة: إخبار Scribe أن يمسح كل الروابط المسجلة في لارافيل
            'include' => [], 
            'exclude' => [],
        ],
    ],
    ...
    'auth' => [
        ...
        'default' => true, // غيرها إلى true ليتم اعتبار التوكن مطلوباً لكل الروابط تلقائياً
        'in' => AuthIn::HEADER->value, // استخدم HEADER لـ Bearer Token
        'name' => 'Authorization', // الاسم الصحيح للهيدر
        'placeholder' => 'Bearer {YOUR_TOKEN}',
        'extra_info' => 'يجب إرسال التوكن في هيدر الطلب بتنسيق Bearer {token}',
    ],
